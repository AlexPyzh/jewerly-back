...
public interface IAiPreviewService
{
    ...
    /// <param name="userId">ID текущего пользователя (null для гостей)</param>
    ...
    /// <exception cref="ArgumentException">Если конфигурация не найдена или GuestClientId пустой для гостя</exception>
    /// <exception cref="JewerlyBack.Infrastructure.Exceptions.AiLimitExceededException">Если гость превысил лимит генераций</exception>
